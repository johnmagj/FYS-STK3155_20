...
We start off by examning the so called Franke function, \vref{eq:Franke}. The formula give us a set of values located in above the xy-plane similar to altitude points.
